...
public interface ICommandIds {
	...
	public static final String RADIO_STATE = "org.eclipse.ui.commands.radioStateParameter";
	public static final String RADIO_STATE_DISABLE = "disable";

	public static final String CMD_TELEMETRY = "it.bladecopter.actions.TelemetryCommand";
	public static final String CMD_SAVE_TELEMETRY = "telemetry.save";

	public static final String CMD_ABOUT = "it.xbladecopter.about";
